...
{
private :
   // points to menoty where header is located
   dmsHeader          *_header ;
...
private :
   ...
   //update free space
   void _updateFreeSpace ( dmsPageHeader *header, int changerSize,
                           PAGEID pageID ) ;
   // find a page id to insert, return invalid_pageid if therre's no page canb e found for required size bytes 
